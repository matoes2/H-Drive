...
task main()
{
	//FOR USE WITH BUGGY BOT ONLY, DOES NOT WORK WITH ANY OTHER BOT
	...
	motor[rightMotor] = 127;		  // Motor on port2 is run at full (127) power forward
	motor[leftMotor]  = 90;		  // Motor on port3 is run at full (127) power forward
	wait1Msec(40);
	...
	motor[rightMotor] = 10;		  // Motor on port2 is run at full (127) power forward
	motor[leftMotor]  = 127;		  // Motor on port3 is run at full (127) power forward
	wait1Msec(800);
	...
	motor[rightMotor] = 50;		  // Motor on port2 is run at full (127) power forward
	motor[leftMotor]  = 127;		  // Motor on port3 is run at full (127) power forward
	wait1Msec(300);

	motor[rightMotor] = 100;		  // Motor on port2 is run at full (127) power forward
	motor[leftMotor]  = 127;		  // Motor on port3 is run at full (127) power forward
	wait1Msec(900);// Robot runs previous code for 3000 milliseconds before moving on
